(function() {
  ...
  travel.controller('travelController', [
    '$scope', 'traveltravel', '$state', '$stateParams', '$window',
    function($scope, traveltravel, $state, $stateParams, $window) {
      var vm = this;
      $('.profile').css({
  ...
  /** travel */
  travel.factory('traveltravel', ['$http', 'URL',
    function($http, URL) {
      return {
        getMenus: getMenus,
        getDetail: getDetail,
  ...
  travel.directive('travelChartCpi', ['traveltravel', '$window',
    function(traveltravel, $window) {
      return {
        restrict: 'ACE',
        scope: {
          ccontent: '='
        ...
        link: function(scope, element, attrs) {
          ...
          traveltravel.getDetail(scope.ccontent.url, {
            queryTime: traveltravel.getDateFormat(scope.ccontent.model, scope.ccontent.format),
  ...
  // 经济类型增速分析
  travel.directive('travelChartEco', ['traveltravel', '$window',
    function(traveltravel, $window) {
      return {
        restrict: 'ACE',
        scope: {
