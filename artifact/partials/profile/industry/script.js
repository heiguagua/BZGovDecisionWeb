(function() {
  ...
  industry.directive('indstChartCpi', ['industryService', '$window',
    function(industryService, $window) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          industryService.getDetail(scope.ccontent.url, {
            queryTime: industryService.getDateFormat(scope.ccontent.model, scope.ccontent.format),
